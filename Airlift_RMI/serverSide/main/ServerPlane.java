...
public class ServerPlane {
	   ...
	   */
	   ...
	   public static void main (String[] args)
	   {
	     ...
	     /* register it with the general registry service */
	      ...
	      try
	      { while (!end)
	          synchronized (Class.forName ("serverSide.main.ServerPlane"))
	          { try
	            { (Class.forName ("serverSide.main.ServerPlane")).wait ();
	            }
	      ...
	      { GenericIO.writelnString ("The data type ServerPlane was not found (blocking)!");
	        e.printStackTrace ();
	        System.exit (1);
	      }
	     ...
	     /* server shutdown */
	      ...
	      boolean shutdownDone = false;             	 // flag signaling the shutdown of the plane service
	   ...
	   */
	   ...
	   public static void shutdown ()
	   {
	      ...
	      try
	      { synchronized (Class.forName ("serverSide.main.ServerPlane"))
	        { (Class.forName ("serverSide.main.ServerPlane")).notify ();
	        }
	      }
	     catch (ClassNotFoundException e)
	     { GenericIO.writelnString ("The data type ServerPlane was not found (waking up)!");
	       e.printStackTrace ();
	       System.exit (1);
	     }
	   }
